...
class aged_sale_report_invoice_wiz(osv.osv_memory):
    _name = "aged.sale.report.invoice.wiz"
    ...
    def print_report(self,cr,uid,ids,context=None):
        ...
        result = mod_obj.get_object_reference(cr, uid, 'st_sale_report', 'action_account_tree_report')
        ...
        if data['from_period_id'] and data['to_period_id']:
            ...
            result['domain'].append(('date_invoice', '>=', from_date))
            result['domain'].append(('date_invoice', '<=', to_date))
        if data['start_date'] and data['end_date']:
            result['domain'].append('&')
            result['domain'].append(('date_invoice', '>=', data['start_date']))
            result['domain'].append(('date_invoice', '<=', data['end_date']))
        return result
